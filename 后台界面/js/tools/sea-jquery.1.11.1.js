define(function(require, exports, module) {
    ...
    (function(a) { a.fn.scrollLoading = function(b) {
            ...
            var e = function() {
                ...
                if (d.container.get(0) === window) { contop = a(window).scrollTop() } else { contop = d.container.offset().top }
                a.each(d.cache, function(m, n) {
                    ...
                    if (p) { l = p.offset().top - contop, h = l + p.height();
                        if ((l >= 0 && l < g) || (h > 0 && h <= g)) {
                            if (k) {
                                if (j === "img") { f(p.attr("src", k)) } else { p.load(k, {}, function() { f(p) }) } } else { f(p) }
                            n.obj = null } } }) };
            e();
            d.container.bind("scroll", e) } })(jQuery);
    function sJumpSl(box) { $("html,body").animate({ scrollTop: $("#" + box).offset().top }, 1000); }
